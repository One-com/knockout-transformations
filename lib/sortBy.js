(function (root, factory) {
    ...
    function SortedStateItem(transformation, inputItem, mockStateItem) {
        ...
        if (mockStateItem) {
            //mockStateItems only evaluate once (they are created and destroyed)
            //therefore don't waste processing creating a computed
            this.previousMappedValue = this.mappingEvaluator.call(this);
            if (this.transformation.options.disposeItem) {
                this.transformation.options.disposeItem(this.previousMappedValue, mockStateItem);
            }
        } else {
    ...
    SortedStateItem.prototype.dispose = function () {
        if (!this.mockStateItem) {
            this.mappedValueComputed.dispose();
        }
        if (this.transformation.options.disposeItem) {
            this.transformation.options.disposeItem(this.previousMappedValue, this.mockStateItem);
        }
    };
